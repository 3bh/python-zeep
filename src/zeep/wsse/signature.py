...
class MemorySignature(object):
    ...
    def __init__(self, key_data, cert_data, verify_cert_data, password=None):
        check_xmlsec_import()
    ...
    def verify(self, envelope):
        key = _make_verify_key(self.verify_cert_data or self.cert_data)
...
class Signature(MemorySignature):
    ...
    def __init__(self, key_file, certfile, password=None, verify_certfile=None):
        super(Signature, self).__init__(
            _read_file(key_file), _read_file(certfile), _read_file(verify_certfile) if verify_certfile else None, password
        )
